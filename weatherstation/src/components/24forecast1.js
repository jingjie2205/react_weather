...
const Forecast1 = () => {
    ...
    const data_west = data && !error ? data.items[0].periods[1].regions.west:[];
    const data_north = data && !error ? data.items[0].periods[1].regions.north:[];
    const data_south = data && !error ? data.items[0].periods[1].regions.south:[];
    const data_east = data && !error ? data.items[0].periods[1].regions.east:[];
    const data_central = data && !error ? data.items[0].periods[1].regions.central:[];
